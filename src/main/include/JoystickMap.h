...
class JoystickMap {
	...
	public:
		...
		//Button function IDs
		const static int HANG_SOLENOID_FORWARD_BUTTON_ID = BASE_UPPER_RIGHT_BUTTON_ID;
		const static int HANG_SOLENOID_REVERSE_BUTTON_ID = BASE_UPPER_LEFT_BUTTON_ID;
		const static int PUSH_HANG_BUTTON_ID = BASE_MIDDLE_RIGHT_BUTTON_ID;
		const static int PULL_HANG_BUTTON_ID = BASE_MIDDLE_LEFT_BUTTON_ID;
