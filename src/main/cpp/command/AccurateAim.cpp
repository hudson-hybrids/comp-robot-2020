...
AccurateAim::AccurateAim(NetworkTablesManager *networkTablesManager, frc::SpeedControllerGroup *leftDrive, frc::SpeedControllerGroup *rightDrive, const double LINEAR_TOLERANCE_in, const double ANGULAR_TOLERANCE_in) {
